...
import com.landclaims.LandClaimsAccess;
...
public class ClaimImageBuilder {
    ...
    private ClaimImageBuilder generateImageAsync() {
        ...
        UUID claimOwner = LandClaimsAccess.getClaimOwner(worldName, chunkX, chunkZ);
        ...
        UUID[] nearbyOwners = new UUID[]{
                LandClaimsAccess.getClaimOwner(this.worldChunk.getWorld().getName(), chunkX, chunkZ + 1), // SOUTH
                LandClaimsAccess.getClaimOwner(this.worldChunk.getWorld().getName(), chunkX, chunkZ - 1), // NORTH
                LandClaimsAccess.getClaimOwner(this.worldChunk.getWorld().getName(), chunkX + 1, chunkZ), // EAST
                LandClaimsAccess.getClaimOwner(this.worldChunk.getWorld().getName(), chunkX - 1, chunkZ), // WEST
        };
